...
async def test_grounding() -> None:
    ...
    async with (
        ...
        # A personal, out-of-scope question may route to a retrieval tool first.
        # Mock the Moss-backed tools so the eval is deterministic and needs no
        # Moss credentials or network — the stores legitimately hold nothing
        # relevant. See
